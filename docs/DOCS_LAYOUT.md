...
| **operational/** | What automation cannot do reliably, and the manual step that covers it | [`automation-gaps.md`](operational/automation-gaps.md), [`perf-baseline-phase0.md`](operational/perf-baseline-phase0.md) — Phase 0 meter/bake/gate baseline, per [automation-standards.mdc](../.cursor/rules/automation-standards.mdc) |
